...
public class FileOptionScreen implements Screen {
    ...
    public void AddFile() {
        System.out.println("Please enter the new filename to be added:");
		...
		try {
			...
			File file = new File(dir.getName() + fileName);
		      ...
		      if (file.createNewFile()) {
		    	  System.out.println("Your file has been successfully created : " + file.getName());
		    	  dir.getFiles().add(file);
		    	  
		      } else {
		        System.out.println("This file already exits, please enter a different name.");
		      }
		}catch (IOException e){
    ...
    public void DeleteFile() {
    	...
    	System.out.println("Please enter the filename you wish to delete : ");
		...
		File file = path.toFile();
	      if (file.delete()) {
	    	  System.out.println("You have successfully deleted the file : " + file.getName());
